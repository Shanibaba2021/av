...

{
    ...
    function getList($table)
    {
        ...
        $this->db->select("*,CONCAT(tbl_users.fname,' ',tbl_users.lname) as fieldworker,tbl_branches.bname  as branch,tbl_gender.gender as gender,tbl_yes.status  as insurance,tbl_house.house_status as own_house,tbl_work.work_name as type_work,tbl_secheck.status as security_equipment,tbl_expose.status as politically_exposed");
