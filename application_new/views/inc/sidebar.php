            ...
            <div class="main-navbar">
              <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link menu-title" href="<?php echo base_url(); ?>dashboard" target="_blank"><i data-feather="home"></i><span>Dashboard</span></a></li>
                  ...
                  <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="feather"></i><span>TSession</span></a>
                    <ul class="nav-submenu menu-content">
                      <li>
                        <a class="submenu-title" href="<?php echo base_url(); ?>tsession/add">New TSession</a>
                      </li>
                      <li>
                        <a class="submenu-title" href="<?php echo base_url(); ?>tsession">List TSession</a>
                      </li>
                    </ul>
                  </li>
