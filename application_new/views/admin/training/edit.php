                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <div>
                            ...
                            <input type="text" class="form-control" id="desc" name="desc" value="<?php echo set_value("descipation", html_entity_decode($beneficiary->descipation)); ?>">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <label for="safety_kit" class="col-sm-3 control-label"> Video Links </label>
