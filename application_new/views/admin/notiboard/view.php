  							...
  							<table class="display" id="basic-1">
  								...
  								<tr>
  									...
  									<td>
  										...
  										<?php echo set_value("description",  html_entity_decode($beneficiary->description)); ?>
  								...
  								<tr>
  									...
  									<td>
  										...
  										<label for="link" class="control-label">Notice </label>

  									</td>

  									<td>

  										<?php echo set_value("notice",  html_entity_decode($beneficiary->notice)); ?>
