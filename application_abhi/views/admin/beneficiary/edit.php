                        ...
                        <div class="card-header pb-0">
                            ...
                            <form action="" id="" class="form-horizontal " method="post" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    ...
                                    <drelation_with_insurediv class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <?php echo form_error("training_id", "<span class='label label-danger'>", "</span>") ?>
                                        </div>
                                                    ...
                                                    <select class="form-control select2" name="type_work" id="type_work">
                                                        ...
                                                        if (isset($work) && !empty($work)) :
                                                            ...
                                                            foreach ($work as $key => $value) : ?>
                                                                ...
                                                                <option value="<?php echo $value->id; ?>" <?php echo $value->id == $beneficiary->type_work ? 'selected="selected"' : ""; ?>>
