        ...
        <ul class="list-unstyled topbar-right-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <span  style="color: #fff;">
                    ...
                    <?php } else if($this->session->userdata('role_id') == 1 && $this->session->userdata('type_organization') == 1) {?> 
                        <span class="account-position">Enterprise</span> 
                    <?php } else if($this->session->userdata('role_id') == 1 && $this->session->userdata('type_organization') == 2) {?> 
                        <span class="account-position">University</span>
                    <?php } else if($this->session->userdata('role_id') == 2 && $this->session->userdata('is_instructor') == 1) {?> 
                        <span class="account-position">Instructor</span>
                    <?php } else if($this->session->userdata('role_id') == 2 && $this->session->userdata('is_instructor') == 2) {?> 
