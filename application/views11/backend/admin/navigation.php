...
<div class="left-side-menu left-side-menu-detached">
	...
	<ul class="metismenu side-nav side-nav-light">
		...
		<?php if (has_permission('course')) : ?>
			<?php if ($admin_details['type_organization'] == '2') : ?>
		...
		<?php if (has_permission('user')) : ?>
			<?php if ($admin_details['type_organization'] == '1' || $this->session->userdata('user_id')==1) : ?>
				<li class="side-nav-item <?php if ($page_name == 'jobs' || $page_name == 'jobs_add' || $page_name == 'jobs_edit') echo 'active'; ?>">
					<a href="javascript: void(0);" class="side-nav-link <?php if ($page_name == 'jobs' || $page_name == 'jobs_add' || $page_name == 'jobs_edit' ) : ?> active <?php endif; ?>">
						<i class="dripicons-archive"></i>
					...
					<ul class="side-nav-second-level" aria-expanded="false">
						<?php if (has_permission('user')) : ?>
							<li class="<?php if ($page_name == 'jobs' || $page_name == 'job_edit') echo 'active'; ?>">
								<a href="<?php echo site_url('admin/get_jobs'); ?>"><?php echo get_phrase('manage_job'); ?></a>
							</li>
						<?php endif; ?>

						<?php if (has_permission('user')) : ?>
							<li class="<?php if ($page_name == 'course_add') echo 'active'; ?>">
								<a href="<?php echo site_url('admin/jobs/add_jobs'); ?>"><?php echo get_phrase('add_new_job'); ?></a>
							</li>
						<?php endif; ?>
