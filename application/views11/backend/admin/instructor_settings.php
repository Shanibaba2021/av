            ...
            <div class="card-body">
                ...
                <form action="<?php echo site_url('admin/instructor_settings/update'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="hidden" name = "instructor_revenue" id = "instructor_revenue" class="form-control" value="0">
                            <input type="number" name = "admin_revenue" id = "admin_revenue" class="form-control" >
                            <div class="input-group-append">
                                <span class="input-group-text"><i class="mdi mdi-percent"></i></span>
                            </div>
                        </div>
