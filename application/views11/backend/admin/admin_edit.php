...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-4"><?php echo get_phrase('admin_edit_form'); ?>
                    <?php if ($user_data['status'] == 0) { ?>
                        <a href="<?php echo base_url('admin/admins/approve/' . $user_data['id']) ?>" ><button class="btn btn-primary alignToTitle">Approve</button></a>
                    <?php } elseif ($user_data['status'] == 1) { ?>
                        <a href="<?php echo base_url('admin/admins/block/' . $user_data['id']) ?>"><button class="btn btn-primary alignToTitle">Block</button></a>
                    <?php } ?>
                </h4>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="university_name"><?php echo get_phrase('university_name'); ?> <span class="required">*</span> </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="university_name" name="university_name" value="<?php echo $user_data['university_name']; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="organization_address"><?php echo get_phrase('organization_address'); ?> <span class="required">*</span> </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="organization_address" name="organization_address" value="<?php echo $user_data['address']; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="university _image"><?php echo get_phrase('university_image'); ?></label>
                                            <div class="col-md-9">
                                                <div class="d-flex">
                                                    <div class="">
                                                    ...
                                                    <div class="flex-grow-1 mt-1 pl-3">
                                                        <div class="input-group">
                                                            <div class="custom-file">
                                                                ...
                                                                <label class="custom-file-label ellipsis" for="user_image"><?php echo get_phrase('choose_university_image'); ?></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
