...
<script src="<?php echo site_url('assets/backend/js/custom.js');?>"></script>
    ...
    <!-- Plugins JS start-->
    <script src="<?php echo site_url('assets/backend/js');?>/editor/ckeditor/ckeditor.js"></script>
    <script src="<?php echo site_url('assets/backend/js');?>/editor/ckeditor/adapters/jquery.js"></script>
    <script src="<?php echo site_url('assets/backend/js');?>/editor/ckeditor/styles.js"></script>
    <script src="<?php echo site_url('assets/backend/js');?>/editor/ckeditor/ckeditor.custom.js"></script>
    <!-- Plugins JS Ends-->
