<section class="py-5 bg-light job-listing-page">
    <div class="container">
        ...
        <h4>Browsing Enterprises In Malaysia</h4>
                ...
                <div class="card h-100 job-listing-box shadow-sm border-light">
                    <div class="card-body">
                        <span class="d-flex justify-content-between">
                            <a href="<?php echo site_url('home/comapny_details/'. $user->id); ?>" class="job-title"><?php echo $user->university_name ?></a> <a href="<?php echo site_url('home/comapny_details/'. $user->id); ?>"><i class="far fa-heart"></i></a>
                        </span>
                        <span class="d-flex">

                            <a href="<?php echo site_url('home/comapny_details/'. $user->id); ?>" class="job-image"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Bootstrap_logo.svg/512px-Bootstrap_logo.svg.png" class="w-100"></a>
                            <a href="<?php echo site_url('home/comapny_details/'. $user->id); ?>" class="job-location">
                                <span >
                                    <?php echo $user->university_name; ?>
                                </span>
                            </a>
                        </span>
                        ...
                        <span class="d-flex justify-content-between">
                            <a href="<?php echo site_url('home/jobs_details/'. $user->id); ?>" class="btn btn-warning btn-sm">Featured</a>
                        </span>
                    </div>
                </div>
            </div>
