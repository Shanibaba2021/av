              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">List Training Video</li>
                  </ol>
                </div>
                ...
                <div class="social-tab">
                  <div class="input-group">
                    <ul class="nav nav-tabs" id="top-tab" role="tablist">
                      <li class="nav-item"><button class="dt-button" tabindex="0" aria-controls="basic-branch" type="button"><a href="<?php echo base_url() ?>admin/training/add"> <span>Add New Training</span></a></button> </li>
                    </ul>
                  </div>
                  <ul class="nav nav-tabs" id="top-tab" role="tablist">
                        ...
                        ?>
                          ...
                          ?>
                            ...
                            <tr id="hide<?php echo $value->id; ?>">
                              ...
                              <th><?php if (!empty($value->descipation)) {
                                    echo $value->descipation;
                                  } ?></th>
                              ...
                              <th class="action-width table-btn-responsive">
                                <a href="<?php echo base_url() ?>admin/training/view/<?php echo $value->id; ?>" title="View">

                                  <span class="btn btn-info "><i class="fa fa-eye"></i></span>

                                </a>

                                <a href="<?php echo base_url() ?>admin/training/edit/<?php echo $value->id; ?>" title="Edit">

                                  <span class="btn btn-info "><i class="fa fa-edit"></i></span>

                                </a>

                                <a href="<?php echo base_url() ?>admin/training/delete/<?php echo $value->id; ?>/tbl_training">
