<?php $social_links = json_decode($edit_data[0]->social_links, true); ?>
                ...
                <div class="user-dashboard-box">
                    <div class="user-dashboard-sidebar">
                        <div class="user-box">
                            ...
                            <div class="name">
                                <div class="name"><?php echo $edit_data[0]->first_name.' '.$edit_data[0]->last_name; ?></div>
                            </div>
                        </div>
                            ...
                            <div class="content-box">
                                <div class="basic-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name = "first_name" id="FristName" placeholder="<?php echo site_phrase('first_name'); ?>" value="<?php echo $edit_data[0]->first_name; ?>">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name = "last_name" placeholder="<?php echo site_phrase('last_name'); ?>" value="<?php echo $edit_data[0]->last_name; ?>">
                                    </div>


                                    <?php if(($edit_data[0]->is_instructor) > 0): ?>
                                        <div class="form-group">
                                            <label for="Biography"><?php echo site_phrase('title'); ?>:</label>
                                            <textarea class="form-control" name = "title" placeholder="<?php echo site_phrase('short_title_about_yourself'); ?>"><?php echo $edit_data[0]->title; ?></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="skills"><?php echo get_phrase('your_skills'); ?></label>
                                            <input type="text" class="form-control bootstrap-tag-input" id = "skills" name="skills" data-role="tagsinput" style="width: 100%;" value="<?php echo $edit_data[0]->skills;  ?>"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control author-biography-editor" name = "biography" id="Biography"><?php echo $edit_data[0]->biography; ?></textarea>
                                    </div>
                                </div>
