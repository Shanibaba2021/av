                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <input type="hidden" class="form-control" id="uid" value="1" name="uid" >
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="university_name"><?php echo get_phrase('organizations'); ?><span class="required">*</span></label>
                                            <div class="col-md-9">
                                                <div class="row text-center">
                                                    <div class="col-sm-4 col-xs-6">
                                                        <input type="radio" id="organization" name="organization" value="1">
                                                        <label for="organization">Enterprise</label>
                                                    </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="user_image"><?php echo get_phrase('university_image'); ?></label>
                                            <div class="col-md-9">
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        ...
                                                        <label class="custom-file-label" for="user_image"><?php echo get_phrase('choose_university_image'); ?></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
