                            ...
                            <div id="basicwizard">
                                ...
                                <div class="tab-content b-0 mb-0">
                                    <div class="tab-pane" id="curriculum">
                                        <?php
                                        if ($course_details['course_type'] == 'self_paced' || $course_details['course_type'] == 'hybrid' || $course_details['course_type'] == 'live classes') :
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        ?>
                                                            ...
                                                            ?>
                                                                <?php $instructor_details = $this->user_model->get_instructor_data($instructor_id)->row_array();
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="select2 form-control select2-multiple" data-toggle="select2"  multiple="multiple" data-placeholder="Choose ..." name="new_instructors[]">
                                                             <?php
                                                            //$collageid = $this->session->userdata("user_id") ;
                                                            $instructors = $this->user_model->get_instructor()->result_array();
                                                           // echo $this->db->last_query() ; die("sssss");
                                                            ?>
