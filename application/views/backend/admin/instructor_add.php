                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <input type="hidden" class="form-control" id="university_name" value=" " name="university_name">
                                                <input type="hidden" class="form-control" id="organization" value=" " name="organization">
                                                <input type="hidden" class="form-control" id="organization_address" value=" " name="organization_address">
                                            </div>
                                        </div>
