                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select class="form-control select2" data-toggle="select2" name="course_type" id="course_type">
                                                                <option value="self_paced"><?php echo get_phrase('self_paced'); ?></option>
                                                                <option value="live_classes"><?php echo get_phrase('live_classes'); ?></option>
                                                                <option value="hybrid"><?php echo get_phrase('hybrid'); ?></option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                <?php else : ?>
                                                ...
                                                <?php if ($this->session->userdata('user_id') == 1) { ?>
                                                    <div class="form-group row mb-3">
                                                        <label class="col-md-2 col-form-label" for="select_instructor"><?php echo get_phrase('select_university'); ?></label>
                                                        <div class="col-md-10">
                                                            <select class="form-control select2" name="select_instructor" onChange="get_instructor(this.value);" id="select_instructor">
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        <label class="col-md-2 col-form-label" for="select_instructor"><?php echo get_phrase('select_instructor'); ?></label>
                                                        <div class="col-md-10">
                                                ...
                                                <?php } else { ?>
                                                    <input type="hidden" class="custom-control-input" name="select_instructor" id="select_instructor" value="1">
                                                    <input type="hidden" class="custom-control-input" name="instructor" id="instructor" value="1">
                                                <?php } ?>
                                            </div> <!-- end col -->
                                        </div> <!-- end row -->
                                    </div> <!-- end tab pane -->
...
<script>
    function get_instructor(val) {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('admin/getusers'); ?>",
            data: 'select_instructor=' + val,
            datatype: "json",
