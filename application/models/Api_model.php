...
class Api_model extends CI_Model
{
    ...
    function addNewBeneficiary($BeneficiaryInfo)
    {
        ...
        foreach ($safety_kit as  $value) {
            ...
            $this->db->where("assign_quantity !=", 0);
    ...
    function getInsurancelistbybid($table, $bId, $fId)
    {
        ...
        $this->db->select("fId,bId,bId as insurance_id,insurance,insured_name,nominee_name,nominee_dob,relation_with_insured,date_from_policy,politically_exposed,relation_with_insured_name,father_husband_name");
    ...
    function gettsession($table, $fid, $bid)
    {
        ...
        $this->db->select("tbl_session.id,tbl_session.address,tbl_session.name as name,CONCAT(tbl_users.fname,' ',tbl_users.lname) as fieldworker,tbl_branches.bname as bname,tbl_session.bid as branchId,tbl_session.created as created");
