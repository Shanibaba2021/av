...

{
    ...
    function getRows($table, $bId)
    {
        ...
        $this->db->join("tbl_work", "tbl_work.id = tbl_beneficiary.type_work", "left");
        $this->db->join("tbl_secheck", "tbl_secheck.id = tbl_beneficiary.security_equipment", "left");
        $this->db->join("tbl_typeinsurance", "tbl_typeinsurance.id = tbl_beneficiary.other_insurance", "left");
        $this->db->join("tbl_expose", "tbl_expose.id = tbl_beneficiary.politically_exposed", "left");
    ...
    function getRow($table, $id)
    {
        ...
        $this->db->select("$table.* ,tbl_branches.bname  as branch,tbl_gender.gender as gender,tbl_house.house_status as own_house,tbl_secheck.status as security_equipment,");
    ...
    function getInsurancesdata($table)
    {
        $this->db->select("bId,politically_exposed,insured_name,nominee_dob,relation_with_insured,relation_with_insured_name,nominee_name");

        $this->db->from($table);

        $this->db->where('tbl_beneficiary.insurance !=', 0);
