                            ...
                            <form action="" id="" class="form-horizontal " method="post" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <select class="form-control select2" name="caste" id="caste">
                                                        ...
                                                        <option value="0" <?php if ($beneficiary->caste == 0)   echo 'selected="selected"';  ?>>General</option>
                                                        <option value="1" <?php if ($beneficiary->caste == 1)   echo 'selected="selected"';  ?>>OBC</option>
                                                        <option value="2" <?php if ($beneficiary->caste == 2)   echo 'selected="selected"';  ?>>SC</option>
                                                        <option value="3" <?php if ($beneficiary->caste == 3)   echo 'selected="selected"';  ?>>ST</option>
                                                        <option value="4" <?php if ($beneficiary->caste == 4)   echo 'selected="selected"';  ?>>Other</option>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <select class="form-control select2" name="qualification" id="qualification">
                                                        ...
                                                        <option value="0" <?php if ($beneficiary->qualification == 0)   echo 'selected="selected"';  ?>>Illiterate</option>
                                                        <option value="1" <?php if ($beneficiary->qualification == 1)   echo 'selected="selected"';  ?>>5th</option>
                                                        <option value="2" <?php if ($beneficiary->qualification == 2)   echo 'selected="selected"';  ?>>8th</option>
                                                        <option value="3" <?php if ($beneficiary->qualification == 3)   echo 'selected="selected"';  ?>>10th</option>
                                                        <option value="4" <?php if ($beneficiary->qualification == 4)   echo 'selected="selected"';  ?>>12th</option>
                                                        <option value="5" <?php if ($beneficiary->qualification == 5)   echo 'selected="selected"';  ?>>Graduation</option>
                                                    </select>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="House" <?php if ($beneficiary->house == '0') { ?> style="display:none;" <?php }  ?>>
                                                <label for="exampleInputPassword1" class="control-label"> Select House Type</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1" class="control-label"> Training Session</label>
                                                <div>
                                                    <div class="row text-center">
                                                        <div class="col-sm-4 col-xs-6">
                                                            <!-- checkbox -->
                                        ...
                                        <div class="col-md-6">
                                            <div class="session" <?php if ($beneficiary->tsession == '0') { ?> style="display:none;" <?php }  ?>>
                                                <label for="exampleInputPassword1" class="control-label"> Select Training Session</label>
                                    ...
                                    <div class="row insurance" <?php if ($beneficiary->insurance == '0') { ?> style="display:none;" <?php }  ?>>
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="relation_with_insured" id="relation_with_insured">

                                                    <option class="hide8" value="">Select Relation With Insured </option>
                                                    <option class="hide8" value="0" <?php if ($beneficiary->relation_with_insured == 0)   echo 'selected="selected"';  ?>>Father</option>
                                                    <option class="hide8" value="1" <?php if ($beneficiary->relation_with_insured == 1)   echo 'selected="selected"';  ?>>Mother</option>
                                                    <option class="hide8" value="2" <?php if ($beneficiary->relation_with_insured == 2)   echo 'selected="selected"';  ?>>Wife</option>
                                                    <option class="hide8" value="3" <?php if ($beneficiary->relation_with_insured == 3)   echo 'selected="selected"';  ?>>Son</option>
                                                    <option class="hide8" value="4" <?php if ($beneficiary->relation_with_insured == 4)   echo 'selected="selected"';  ?>>Daughter</option>
                                                    <option class="hide8" value="5" <?php if ($beneficiary->relation_with_insured == 5)   echo 'selected="selected"';  ?>>Brother</option>
                                                    <option class="show8" value="6" <?php if ($beneficiary->relation_with_insured == 6)   echo 'selected="selected"';  ?>>Other</option>
                                                </select>
                                    ...
                                    <div class="row insurance" <?php if ($beneficiary->insurance == '0') { ?> style="display:none;" <?php }  ?>>
                                        ...
                                        <div class="col-md-6 relation_with_insuredss" <?php if ($beneficiary->relation_with_insured != '6') { ?> style="display:none;" <?php }  ?>>
                                            <div class="form-group">

                                                <label for="relation_with_insured_name" class="control-label"> Relation With Insured</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1" class="control-label"> Other Insurance</label>
                                                <div>
                                                    <div class="row text-center">
                                                        <div class="col-sm-4 col-xs-6">
                                                            <!-- checkbox -->
                                            ...
                                            <div class="form-group other_insurance" <?php if ($beneficiary->other_insurance == '0') { ?> style="display:none;" <?php }  ?>>
                                                ...
                                                <div>
                                                    <select class="form-control select2" name="insurance_type" id="insurance_type">
                                                        ...
                                                        <option value="1" <?php if ($beneficiary->other_insurance == 1)   echo 'selected="selected"';  ?>>Health Insurance</option>
                                                        <option value="2" <?php if ($beneficiary->other_insurance == 2)   echo 'selected="selected"';  ?>>Life Insurance</option>
                                                        <option value="3" <?php if ($beneficiary->other_insurance == 3)   echo 'selected="selected"';  ?>>Other Insurance</option>
                                                    </select>
                                                </div>
                                    ...
                                    <div class="row other_insurance" <?php if ($beneficiary->other_insurance == '0') { ?> style="display:none;" <?php }  ?>>
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="insurance_company " class="control-label"> Insurance Company </label>
    ...
    <script>
        ...
        $(document).ready(function() {
            $(".hide8").click(function() {
                $(".relation_with_insuredss").hide();
            });
            $(" .show8").click(function() {
                $(".relation_with_insuredss").show();
            });
        });
