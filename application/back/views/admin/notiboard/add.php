                ...
                <form action="" id="" class="form-horizontal " method="post" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <label class="col-sm-3 control-label" for="image">Notice</label>
                      ...
                      <div class="col-sm-5">
                        ...
                        <?php echo form_error("notice", "<span class='label label-danger'>", "</span>") ?>
                    ...
                    <div class="form-group">
                      ...
                      <div>
                        ...
                        <textarea rows="4" class="form-control" cols="50" id="desc" name="desc"></textarea>
