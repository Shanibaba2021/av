                      ...
                      <table class="display" id="basic-1">
                          ...
                          <tr>
                              ...
                              <td>
                                  ...
                                  <label for="desc" class="control-label">Session Name</label>
                          ...
                          <tr>
                              ...
                              <td>
                                  ...
                                  <label for="link" class="control-label">Branch </label>

                              </td>

                              <td>

                                  <?php echo set_value("bname",  html_entity_decode($data->bname)); ?>
