								...
								<div class="card">
									...
									<div class="card-body">
										<div class="row">
											...
											<div class="mb-3">
												<label class="form-label">Education Qualification : <b><?php echo set_value("qualification", html_entity_decode($beneficiary->qualification)); ?></b></label>
											</div>
											<div class="mb-3">
											...
											<div class="mb-3">
												<label class="form-label">Attand Funcation : <b><?php echo set_value("funcation",  html_entity_decode($beneficiary->funcation_name)); ?></b></label>
											</div>
											<div class="mb-3">
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="mb-3">
										<label class="form-label">Policy Issue Date : <b><?php echo set_value("date_from_policy", html_entity_decode($beneficiary->date_from_policy)); ?> </b></label>
									</div>
								</div>
								<div class="col-md-6">
									<div class="mb-3">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="mb-3">
										<label class="form-label">Relation With Insured : <b><?php echo set_value("relation_with_insured", html_entity_decode($beneficiary->relation_with_insured)); ?></b></label>
									</div>
								</div>
							</div>
