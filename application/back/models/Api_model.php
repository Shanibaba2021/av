...
class Api_model extends CI_Model
{
    ...
    function gettsession($table,$fid,$bid)
    {
        ...
        $this->db->select("tbl_session.id,tbl_session.address,tbl_session.name as name,CONCAT(tbl_users.fname,' ',tbl_users.lname) as fieldworker,tbl_branches.bname as bname");
