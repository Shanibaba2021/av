                                    ...
                                    <div class="row insurance" <?php if ($beneficiary->insurance == '0') { ?> style="display:none;" <?php }  ?>>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="insurance_type" class="control-label"> Type Of Insurance </label>
                                                ...
                                                <div>
                                                    <select class="form-control select2" name="insurance_type" id="insurance_type">
                                                        ...
                                                        if (isset($type_insurance) && !empty($type_insurance)) :

                                                            foreach ($type_insurance as $key => $value) : ?>

                                                                <option value="<?php echo $value->id; ?>" <?php echo $value->id == $beneficiary->insurance ? 'selected="selected"' : ""; ?>>

                                                                    <?php echo $value->insurance; ?>
