                                  ...
                                  <div class="box-body">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-sm-4">
                                              ...
                                              <input type="text" class="form-control" id="eventname" name="eventname" value="<?php echo set_value("eventname", html_entity_decode($beneficiary->eventname)); ?>">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-sm-4">
                                              ...
                                              <input type="text" class="form-control" id="desc" name="desc" value="<?php echo set_value("desc", html_entity_decode($beneficiary->desc)); ?>">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <label for="safety_kit" class="col-sm-3 control-label"> Event Links </label>

                                          <div class="col-sm-4">

                                              <input type="text" class="form-control" id="eventlink" name="eventlink" value="<?php echo set_value("link", html_entity_decode($beneficiary->link)); ?>">
