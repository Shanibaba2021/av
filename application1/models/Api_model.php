...
class Api_model extends CI_Model
{
    ...
    function getInsurancelistbybid($table,$bId,$fId)
    {
        ...
        $this->db->select("insurance,insured_name,nominee_name,nominee_dob,relation_with_insured,date_from_policy,politically_exposed");
