...
class Login_model extends CI_Model
{
    ...
    {
        $this->db->select('BaseTbl.userId,BaseTbl.fname,BaseTbl.image,BaseTbl.password,BaseTbl.isDeleted, BaseTbl.name, BaseTbl.roleId,  Roles.role,tbl_branches.bname as brname');
