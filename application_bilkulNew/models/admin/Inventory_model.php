...
class Inventory_model extends CI_Model
{
    ...
    function getListTableCol($table,$col,$colval,$cole,$colvals)
    {

        $this->db->select("sum(qun)");
    ...
    function get_total_assign($pid,$bid)
    {

        $this->db->select("sum(qun) as qun");
    ...
    function get_remaining_kit($pid,$bid)
    {

        $this->db->select("assign_quantity");

        $this->db->from('tbl_assign_item_branch');

        $this->db->where("pname",$pid);

        $this->db->where("bname",$bid);
