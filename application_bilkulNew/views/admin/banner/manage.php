              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">List Banner</li>
                  </ol>
                </div>
              ...
              <div class="card">
                ...
                <div class="social-tab">
                  <div class="input-group">
                    ...
                    <li class="nav-item"><button class="dt-button" tabindex="0" aria-controls="basic-branch" type="button"><a href="<?php echo base_url() ?>admin/banner/add"> <span>Add New Banner</span></a></button> </li>
                    </ul>
                  </div>
                  <ul class="nav nav-tabs" id="top-tab" role="tablist">
                          ...
                          ?>
                            ...
                            <tr id="hide<?php echo $value->id; ?>">
                              ...
                              <th class="action-width">
                                <a href="<?php echo base_url() ?>admin/banner/view/<?php echo $value->id; ?>" title="View">

                                  <span class="btn btn-info "><i class="fa fa-eye"></i></span>

                                </a>

                                <a href="<?php echo base_url() ?>admin/banner/edit/<?php echo $value->id; ?>" title="Edit">

                                  <span class="btn btn-info "><i class="fa fa-edit"></i></span>

                                </a>

                                <a title="Delete" data-toggle="modal" data-target="#commonDelete" onclick="set_common_delete('<?php echo $value->id; ?>','banner');">
      ...
      $(document).ready(function() {
        ...
        $.fn.dataTable.ext.search.push(
          function(settings, data, dataIndex) {
            var min = minDate.val();
            var max = maxDate.val();
            var date = new Date(data[1].replace(/(\d{2})-(\d{2})-(\d{4})/, "$2/$1/$3"))
