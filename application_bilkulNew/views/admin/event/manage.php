        ...
        <div class="page-body">
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">List Event</li>
                  </ol>
                </div>
          ...
          <div class="container-fluid">
           ...
           <div class="col-sm-12">
            ...
            <li class="nav-item"><button class="dt-button" tabindex="0" aria-controls="basic-branch" type="button"><a href="<?php echo base_url() ?>admin/event/add"> <span>Add New Event</span></a></button> </li>
						</ul>	
					  </div>
					  <ul class="nav nav-tabs" id="top-tab" role="tablist">
                  ...
                  ?>
                    ...
                    ?>
                      ...
                      <tr id="hide<?php echo $value->id; ?>">
                        ...
                        <th><?php if (!empty($value->eventname)) {
                              echo $value->eventname;
                            } ?></th>
                        <th><?php if (!empty($value->desc)) {
                              echo $value->desc;
                            } ?></th>
                        <th><?php if (!empty($value->link)) {
                              echo $value->link;
                            } ?></th>
                        ...
                        <th class="action-width">
                          <a href="<?php echo base_url() ?>admin/event/view/<?php echo $value->id; ?>" title="View">

                            <span class="btn btn-info "><i class="fa fa-eye"></i></span>

                          </a>

                          <a href="<?php echo base_url() ?>admin/event/edit/<?php echo $value->id; ?>" title="Edit">

                            <span class="btn btn-info "><i class="fa fa-edit"></i></span>

                          </a>

                          <a title="Delete" data-toggle="modal" data-target="#commonDelete" onclick="set_common_delete('<?php echo $value->id; ?>','event');">
