                        ...
                        <div class="card-header pb-0">
                            ...
                            <form action="" id="" class="form-horizontal " method="post" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <label for="father_husband_name " class=" control-label"> Father/husband
                                                    Name </label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <select class="form-control select2" name="caste" id="caste">
                                                        <option value="">Select Caste</option>
                                                        <option value="0" <?php if ($beneficiary->caste == 0)   echo 'selected="selected"';  ?>>
                                                            General</option>
                                                        <option value="1" <?php if ($beneficiary->caste == 1)   echo 'selected="selected"';  ?>>
                                                            OBC</option>
                                                        <option value="2" <?php if ($beneficiary->caste == 2)   echo 'selected="selected"';  ?>>
                                                            SC</option>
                                                        <option value="3" <?php if ($beneficiary->caste == 3)   echo 'selected="selected"';  ?>>
                                                            ST</option>
                                                        <option value="4" <?php if ($beneficiary->caste == 4)   echo 'selected="selected"';  ?>>
                                                            Other</option>
                                                    </select>
                                        ...
                                        <!-- <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <?php echo form_error("funcation", "<span class='label label-danger'>", "</span>") ?>
                                    ...
                                    <hr style=" border: 1px solid #dcdcdc; height: 0px; ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label for="current_address " class=" control-label"> Current Address
                                                </label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label for="permanent_address " class=" control-label"> Permanent
                                                    Address </label>

                                                <div>

                                                    <input type="text" class="form-control" id="permanent_address" name="permanent_address" value="<?php echo set_value("permanent_address", html_entity_decode($beneficiary->permanent_address)); ?>">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <?php echo form_error("permanent_address", "<span class='label label-danger'>", "</span>") ?>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="qualification " class=" control-label"> Qualification
                                                </label>
                                                ...
                                                <div>
                                                    ...
                                                    <select class="form-control select2" name="qualification" id="qualification">
                                                        ...
                                                        <option value="0" <?php if ($beneficiary->qualification == 0)   echo 'selected="selected"';  ?>>
                                                            Illiterate</option>
                                                        <option value="1" <?php if ($beneficiary->qualification == 1)   echo 'selected="selected"';  ?>>
                                                            5th</option>
                                                        <option value="2" <?php if ($beneficiary->qualification == 2)   echo 'selected="selected"';  ?>>
                                                            8th</option>
                                                        <option value="3" <?php if ($beneficiary->qualification == 3)   echo 'selected="selected"';  ?>>
                                                            10th</option>
                                                        <option value="4" <?php if ($beneficiary->qualification == 4)   echo 'selected="selected"';  ?>>
                                                            12th</option>
                                                        <option value="5" <?php if ($beneficiary->qualification == 5)   echo 'selected="selected"';  ?>>
                                                            Graduation</option>
                                                    </select>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <label for="f_m_income_daily_income " class="control-label"> Family
                                                    Monthly Income/daily Income </label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="monthly_income" class=" control-label">Monthly Income
                                                </label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <label for="number_earning_family_member " class=" control-label">
                                                    Number Earning Family Member </label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="numbers_children " class=" control-label"> Numbers Children
                                                </label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="married_status" class="control-label"> Married Status
                                                </label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1" class="control-label"> Own
                                                    House</label>
                                                <div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="House" <?php if ($beneficiary->house == '0') { ?> style="display:none;" <?php }  ?>>
                                                <label for="exampleInputPassword1" class="control-label"> Select House
                                                    Type</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1" class="control-label"> Training
                                                    Session</label>
                                                <div>
                                                    <div class="row text-center">
                                                        <div class="col-sm-4 col-xs-6">
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="form-check ">
                                                                    <input class="form-check-input show5" type="radio" id="1" value="1" <?php if ($beneficiary->tsession > '0') echo 'checked="checked"'; ?> name="tsession" style="margin-top: 6px;">
                                                                    <label class="form-check-label">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-8 col-xs-6">
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="form-check">
                                                                    <input class="form-check-input hide5" type="radio" value="0" <?php if ($beneficiary->tsession == '0') echo 'checked="checked"'; ?> name="tsession" style="margin-top: 6px;">
                                                                    <label class="form-check-label">No</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="session" <?php if ($beneficiary->tsession == '0') { ?> style="display:none;" <?php }  ?>>
                                                <label for="exampleInputPassword1" class="control-label"> Select
                                                    Training Session</label>
                                                <select class="form-control select2" name="training_id" id="training_id">
                                                    <?php
                                                    ...
                                                    if (isset($session) && !empty($session)) :
                                                        ...
                                                        foreach ($session as $key => $value) : ?>
                                                            ...
                                                            <option value="<?php echo $value->id; ?>" <?php echo $value->id == $beneficiary->training_id ? 'selected="selected"' : ""; ?>>
                                            ...
                                            <?php echo form_error("tsession", "<span class='label label-danger'>", "</span>") ?>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <label for="security_equipment" class="control-label"> Security
                                                    Equipment </label>
                                    ...
                                    <div class="row insurance" <?php if ($beneficiary->insurance == '0') { ?> style="display:none;" <?php }  ?>>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <label for="nominee_dob" class="control-label"> Nominee Date Of
                                                    Birth</label>
                                    ...
                                    <div class="row insurance" <?php if ($beneficiary->insurance == '0') { ?> style="display:none;" <?php }  ?>>
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="relation_with_insured " class="control-label"> Relation With
                                                    Insured</label>

                                                <select class="form-control select2 relation" name="relation_with_insured" id="relation_with_insured">

                                                    <option value="">Select Relation With Insured </option>
                                                    <option value="0" <?php if ($beneficiary->relation_with_insured == 0)   echo 'selected="selected"';  ?>>
                                                        Father</option>
                                                    <option value="1" <?php if ($beneficiary->relation_with_insured == 1)   echo 'selected="selected"';  ?>>
                                                        Mother</option>
                                                    <option value="2" <?php if ($beneficiary->relation_with_insured == 2)   echo 'selected="selected"';  ?>>
                                                        Wife</option>
                                                    <option value="3" <?php if ($beneficiary->relation_with_insured == 3)   echo 'selected="selected"';  ?>>
                                                        Son</option>
                                                    <option value="4" <?php if ($beneficiary->relation_with_insured == 4)   echo 'selected="selected"';  ?>>
                                                        Daughter</option>
                                                    <option value="5" <?php if ($beneficiary->relation_with_insured == 5)   echo 'selected="selected"';  ?>>
                                                        Brother</option>
                                                    <option value="6" <?php if ($beneficiary->relation_with_insured == 6)   echo 'selected="selected"';  ?>>
                                                        Other</option>
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="politically_exposed" class="control-label"> Politically
                                                    Exposed </label>
                                    ...
                                    <div class="row insurance" <?php if ($beneficiary->insurance == '0') { ?> style="display:none;" <?php }  ?>>
                                        ...
                                        <div class="col-md-6">
                                            <div class="relation_with_insuredss6" <?php if ($beneficiary->relation_with_insured != '6') { ?> style="display:none;" <?php }  ?>>
                                                <div class="form-group">

                                                    <label for="relation_with_insured_name" class="control-label">
                                                        Relation With Insured</label>

                                                    <div>

                                                        <input type="text" class="form-control" id="relation_with_insured_name" name="relation_with_insured_name" value="<?php echo set_value("relation_with_insured_name", html_entity_decode($beneficiary->relation_with_insured_name)); ?>">

                                                    </div>

                                                    <div class="col-sm-5">
                                                        <?php echo form_error("relation_with_insured_name", "<span class='label label-danger'>", "</span>") ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="other_insurance" class="control-label">  </label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1" class="control-label"> Other
                                                    Insurance</label>
                                                <div>
                                                    <div class="row text-center">
                                                        <div class="col-sm-4 col-xs-6">
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="form-check ">
                                                                    <input class="form-check-input show6" type="radio" id="1" value="1" <?php if ($beneficiary->other_insurance > '0') echo 'checked="checked"'; ?> name="other_insurance" style="margin-top: 6px;">
                                                                    <label class="form-check-label">Yes</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-8 col-xs-6">
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="form-check">
                                                                    <input class="form-check-input hide6" type="radio" value="0" <?php if ($beneficiary->other_insurance == '0') echo 'checked="checked"'; ?> name="other_insurance" style="margin-top: 6px;">
                                                                    <label class="form-check-label">No</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <?php echo form_error("other_insurance", "<span class='label label-danger'>", "</span>") ?>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group other_insurance" <?php if ($beneficiary->other_insurance == '0') { ?> style="display:none;" <?php }  ?>>

                                                <label for="insurance_type" class=" control-label"> Insurance Type
                                                </label>

                                                <div>
                                                    <select class="form-control select2" name="insurance_type" id="insurance_type">
                                                        <option value="">Select Insurance</option>
                                                        <option value="1" <?php if ($beneficiary->other_insurance == 1)   echo 'selected="selected"';  ?>>
                                                            Health Insurance</option>
                                                        <option value="2" <?php if ($beneficiary->other_insurance == 2)   echo 'selected="selected"';  ?>>
                                                            Life Insurance</option>
                                                        <option value="3" <?php if ($beneficiary->other_insurance == 3)   echo 'selected="selected"';  ?>>
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <?php echo form_error("insurance_type", "<span class='label label-danger'>", "</span>") ?>
                                    ...
                                    <div class="row other_insurance" <?php if ($beneficiary->other_insurance == '0') { ?> style="display:none;" <?php }  ?>>
                                        <div class="col-md-6">

                                            <div class="form-group">

                                                <label for="insurance_company " class="control-label"> Insurance Company
                                                </label>

                                                <div>

                                                    <input type="text" class="form-control" id="insurance_company" name="insurance_company" value="<?php echo set_value("insurance_company", html_entity_decode($beneficiary->insurance_company)); ?>">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <?php echo form_error("insurance_company", "<span class='label label-danger'>", "</span>") ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <label for="insurance_amount" class="control-label"> Insurance
                                                    Amount</label>

                                                <div>

                                                    <input type="text" class="form-control" id="insurance_amount" name="insurance_amount" value="<?php echo set_value("insurance_amount", html_entity_decode($beneficiary->insurance_amount)); ?>">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <?php echo form_error("insurance_amount", "<span class='label label-danger'>", "</span>") ?>
            ...
            $.ajax({
                ...
                success: function(rep) {
                    ...
                    $.each(data.data, function(i, value) {
                        html += ('<option value="' + value.id + '">' + value.funcation_name +
                            '</option>');
                    });
                    $("#funcation").html(html);
                }
    ...
    <script>
        $(document).ready(function() {
            $('.relation').on('change', function() {
                ...
                if (demovalue != 6) {
                    $(".relation_with_insuredss6").hide();
                } else {
                    $(".relation_with_insuredss" + demovalue).show();
                }
            });
        });
    </script>
