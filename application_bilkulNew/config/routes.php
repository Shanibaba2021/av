...
$route['branchstock'] = "admin/inventory/branchstock";
$route['checkstock/(:num)'] = "admin/inventory/checkstock/$1";
...
$route['insurance_list'] = "admin/insurance/insurance_list";

$route['tsession/add'] = "admin/tsession_1/add";
$route['tsession/view/(:any)'] = "admin/tsession_1/view/$1";
$route['tsession/edit/(:any)'] = "admin/tsession_1/edit/$1";
$route['tsession'] = "admin/tsession_1";

$route['branchesassign/(:num)'] = "admin/branches/assign/$1";
$route['assigned'] = "admin/branches/assigned";
